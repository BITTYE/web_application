...
<tbody>
<tr class="odd gradeX">
<td>2 chicken dosa treat for weekday</td>
<td>Empire</td>
<td>Koramangala, HSR layout</td>
<td>
    <a href="all-tags.php/#dosa">dosa</a>,
    <a href="all-tags.php/#dosa">dosa</a>,
    <a href="all-tags.php/#dosa">dosa</a>,
    <a href="all-tags.php/#restarunt">Restarunt</a>,
    <a href="all-tags.php/#chicken">chicken</a>,
    <a href="all-tags.php/#southIndian">South indian</a>,
</td>
<td>12 Nov 2014</td>
<td>
<button class="btn btn-link" type="button" data-toggle="modal"
        data-target="#grabbed-users-list-deal1">73 Grabs
</button>
...
<tr class="odd gradeX">
    ...
    <td>
        <button class="btn btn-info btn-circle" type="button" data-toggle="modal"
                data-target="#editShopDetails"><i class="fa fa-pencil"></i></button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"
                                aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="myModalLabel">Shop Title</h4></div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form role="form">
                                    <div class="form-group"><label>Shop name</label> <input
                                            class="form-control"></div>
                                    <div class="form-group"><label>Shop Category</label>
                                    ...
                                    <div class="form-group"><label>Shop description</label>
                                    ...
                                    <button type="submit"
                                            class="btn btn-default btn-success"> Add
                                    </button>
...
<td>
<button class="btn btn-link" type="button" data-toggle="modal"
        data-target="#grabbed-users-list-deal1">5 Winners
</button>
<div class="modal fade" id="grabbed-users-list-deal1" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
...
<td>
<button class="btn btn-link" type="button" data-toggle="modal"
        data-target="#grabbed-users-list-deal1">15 Reviews
</button>
<div class="modal fade" id="grabbed-users-list-deal1" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
...
<td>
<button class="btn btn-link" type="button" data-toggle="modal"
        data-target="#grabbed-users-list-deal1">15 Actions to be taken
</button>
<div class="modal fade" id="grabbed-users-list-deal1" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
