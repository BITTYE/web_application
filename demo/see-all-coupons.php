            ...
            <div class="block-content list-coupon clearfix">
                    ...
                    <div class="coupon-content">
                        <div class="img-thumb-center">
                            <div class="wrap-img-thumb">
                                ...
                                <a class="ver_container" href="empire-dosa-deal.php"><img alt="$COUPON_TITLE" src="images/coupons/dosa-small.jpg"></a>
                            </div>
                        </div>
                        ...
                        <a class="btn grabbed btn-take-coupon" href="#">Grabbed!</a>
                    </div>
                ...
                <div class="coupon-item grid_3">
                    <div class="coupon-content">
                        <div class="img-thumb-center">
                            <div class="wrap-img-thumb">
                                <span class="ver_hold"></span>
                                <a class="ver_container" href="empire-dosa-deal.php"><img alt="$COUPON_TITLE"
                                                                                          src="images/coupons/dosa-small.jpg"></a>
                            </div>
                        </div>
                        <div class="coupon-price">Dosa meal for 2</div>
                        <div class="coupon-brand">Empire</div>
                ...
                <div class="coupon-item grid_3">
                    <div class="coupon-content">
                        ...
                        <a class="btn btn-blue btn-take-coupon expired" href="#">Expired</a>
                    </div>
                </div>
                <!--end: .coupon-item -->
                <div class="coupon-item grid_3">
