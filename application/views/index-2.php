...
<!-- Mirrored from envato.megadrupal.com/html/Bittye/light/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Aug 2014 14:41:06 GMT -->
<head>
    <title>Home</title>
    <meta charset="utf-8">
                                ...
                                <form action="#">
                                    <div class="left-form">
                                        ...
                                        <label class="wrap-check" for="sys_chk_news_reg">
                                            <input id="sys_chk_news_reg" class="input-chk" type="checkbox"/> Send me the weekly Bittye.com’s offers.
                                            <i class="icon iUncheck"></i>
                                        </label>
            ...
            <div class="mod-head-slide">
                <div class="grid_frame">
                    <div class="wrap-slide">
                        <p class="ta-c"><img src="<?php echo base_url();?>images/ajax-loader.gif" alt="loading"></p>
                        <div id="sys_head_slide" class="head-slide flexslider">
                            <ul class="slides">
                                <li>
                                    <img src="<?php echo base_url();?>images/ex/01_banner.jpg" alt=""/>
                                </li>
                                <li>
                                    <img src="<?php echo base_url();?>images/ex/02_banner.jpg" alt=""/>
                                </li>
                                <li>
                                    <img src="<?php echo base_url();?>images/ex/03_banner.jpg" alt=""/>
                                </li>
                            </ul>
                        </div>
                    </div>
